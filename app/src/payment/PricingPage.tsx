    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="relative overflow-hidden pt-12 pb-8 px-4">
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <h1 className="text-4xl sm:text-5xl font-black tracking-tight mb-3 leading-[1.08]">
            Simple,{" "}
          ...
          {!user && (
            <p className="mt-3 text-sm text-muted-foreground">
              ...
              and get <strong className="text-foreground">2 bonus credits</strong> — no card required.
            </p>
          )}
        </div>
      </section>
      ...
      <div className="px-4 pb-20">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="max-w-3xl mx-auto mb-8">
            <div className="rounded-xl border border-primary/20 bg-primary/5 px-5 py-3.5 flex items-start sm:items-center gap-3">
              <span className="text-2xl shrink-0">💡</span>
              <p className="text-sm text-muted-foreground leading-relaxed">
                <strong className="text-foreground">1 credit ≈ Rs. 180</strong> — most images cost just{" "}
                <strong className="text-foreground">1 credit</strong>. Credits{" "}
                <strong className="text-green-600 dark:text-green-400">never expire</strong>.{" "}
                <button
                  onClick={() => {
          ...
          <div className="mb-3 text-center">
            <h2 className="text-2xl font-bold tracking-tight mb-1">Choose Your Credit Pack</h2>
              ...
              return (
                ...
                >
                  ...
                  <CardContent className="flex flex-col flex-1 px-6 pb-6">
                    ...
                    {isConfirming ? (
                      <div className="rounded-xl border border-amber-500/40 bg-amber-500/10 p-3 text-center duration-150">
                        <p className="text-xs font-bold text-amber-600 dark:text-amber-400 mb-0.5">
                          Confirm your payment
                        </p>
                        <p className="text-xs text-muted-foreground mb-1">
                          A standard <strong className="text-foreground">3% card processing fee</strong> is added by the payment gateway.
                        </p>
                        <p className="text-xs font-bold text-foreground mb-3">
                          Rs. {pkg.priceLKR.toLocaleString()} + Rs. {(totalWithFee - pkg.priceLKR).toLocaleString()} fee = Total <strong>Rs. {totalWithFee.toLocaleString()}</strong>
                        </p>
          ...
          <div id="provider-rates" className="mb-12">
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="providers" className="border border-border rounded-2xl overflow-hidden bg-card shadow-sm">
                <AccordionTrigger className="px-6 py-4 hover:no-underline hover:bg-accent/40 transition-colors">
                  <div className="flex items-center gap-3 text-left">
                    <span className="text-xl">📋</span>
                    <div>
                      <p className="text-sm font-bold text-foreground">What can I download? — Credit rates by provider</p>
                      <p className="text-xs text-muted-foreground mt-0.5">20+ providers · Images, vectors, icons, video</p>
                    </div>
                  </div>
                </AccordionTrigger>
                <AccordionContent className="px-6 pb-6 pt-2">
                  ...
                  {/* Provider logo grid */}
                  <h3 className="text-base font-bold mb-1">Supported Providers</h3>
                  <p className="text-xs text-muted-foreground mb-6">
                    One credit balance works across all providers. Credit costs vary by provider and file type.
                  </p>
                  ...
                  <h3 className="text-base font-bold mt-8 mb-1">Full Credit Cost Breakdown</h3>
                  <p className="text-xs text-muted-foreground mb-6">
