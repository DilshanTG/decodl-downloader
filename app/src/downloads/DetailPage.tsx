          ...
          <CardContent className="p-6">
            ...
            <div className="mb-8 border-t border-border pt-5">
              ...
              <div className="relative flex items-center justify-between">
                {/* connector line — sits at circle center (top-4 = 16px = half of w-8) */}
                <div className="absolute left-4 right-4 top-4 h-0.5 bg-muted"></div>
                <div
                  className="absolute left-4 top-4 h-0.5 bg-gradient-to-r from-primary to-secondary transition-all duration-500 shadow-[0_0_8px_rgba(107,0,246,0.35)]"
                  style={{
                    ...
                    <div key={step.key} className="relative flex flex-col items-center z-10">
                      <div className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold transition-all duration-300 ${
                        isFailed
                          ...
                          : isCurrent
                          ? "bg-primary text-primary-foreground shadow-[0_0_15px_rgba(107,0,246,0.5)] border border-primary-foreground/20 scale-110"
                          : isActive
