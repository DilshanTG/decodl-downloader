...
function DropdownMenuSubContent({
 ...
 className={cn(
 "bg-popover text-popover-foreground data-[state=open]: data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:-0 data-[state=closed]:zoom-out-95 data-[state=open]: data-[side=bottom]: data-[side=left]: data-[side=right]: data-[side=top]: z-50 min-w-[8rem] origin-[--radix-dropdown-menu-content-transform-origin] overflow-hidden rounded-md border p-1 shadow-lg",
 className
 )}
 {...props}
 />
...
function DropdownMenuContent({
 ...
 "data-[state=open]: data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:-0 data-[state=closed]:zoom-out-95 data-[state=open]: data-[side=bottom]: data-[side=left]: data-[side=right]: data-[side=top]: origin-[--radix-dropdown-menu-content-transform-origin]",
 className
 )}
 {...props}
 />
