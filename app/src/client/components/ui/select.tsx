...
function SelectContent({
 ...
 className={cn(
 "bg-popover text-popover-foreground data-[state=open]: data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:-0 data-[state=closed]:zoom-out-95 data-[state=open]: data-[side=bottom]: data-[side=left]: data-[side=right]: data-[side=top]: relative z-50 max-h-[--radix-select-content-available-height] min-w-[8rem] origin-[--radix-select-content-transform-origin] overflow-y-auto overflow-x-hidden rounded-md border shadow-md",
 position === "popper" &&
